...
public abstract class ExampleBase2 implements Runnable, Updater, Scene {
    private static final Logger logger = Logger.getLogger(ExampleBase2.class.getName());
    ...
    public void init() {
        ...
        try {
            SimpleResourceLocator srl = new SimpleResourceLocator(ResourceLocatorTool.getClassPathResource(
                    ExampleBase2.class, "com/ardor3d/example/media/"));
            ResourceLocatorTool.addResourceLocator(ResourceLocatorTool.TYPE_TEXTURE, srl);
            srl = new SimpleResourceLocator(ResourceLocatorTool.getClassPathResource(ExampleBase2.class,
    ...
    public static void start(ExampleBase2 example) {
        // Ask for properties
    ...
    protected static PropertiesGameSettings getAttributes(final PropertiesGameSettings settings) {
        ...
        if (dflt != null) {
            try {
                dialogImage = ResourceLocatorTool.getClassPathResource(ExampleBase2.class, dflt);
        ...
        try {
            ...
            logger.logp(Level.SEVERE, ExampleBase2.class.getClass().toString(), "ExampleBase2.getAttributes(settings)",
                    "Exception", e);
            return null;
        }
